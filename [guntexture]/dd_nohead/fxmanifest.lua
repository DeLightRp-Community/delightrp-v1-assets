...
--SILAH DAMAGELERI KAFAYA TEK ATMAZ GOVDEYLE AYNI VURUR
--DEADLİGHT

files {
  'data/weapons.meta',
  'data/weaponcombatpdw.meta',
  'data/weaponcompactrifle.meta',
  'data/weaponheavypistol.meta',
  'data/weaponmachinepistol.meta',
  'data/weaponminismg.meta',
  'data/weaponrevolver.meta',
  ...
  'data/weapons_specialcarbine_mk2.meta',
  'data/weaponsnspistol.meta',
  'data/weaponspecialcarbine.meta',
